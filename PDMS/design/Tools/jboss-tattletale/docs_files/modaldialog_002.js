...
var HEADER = "Reminder";
var TEXT_1 = "Community projects represent the latest development releases and are not supported.";
var TEXT_2 = "If you're looking for fully supported, certified, enterprise middleware try JBoss Enterprise Middleware products.";
...
var CANCEL = "Cancel";
var ENTERPRISE_LINK = "http://www.jboss.org/projects/community-enterprise.html";
...
function createDownloadsBox(url) {
   ...
   p2.appendChild(document.createTextNode(TEXT_3));
   ...
   var a2 = p3.appendChild(document.createElement("a"));
   a2.appendChild(document.createTextNode(JBOSSCOM));
   a2.href = JBOSSCOM_LINK;
