...
<TABLE border="0" width="809">
	...
	<TR>
		...
		<TD><a href='meeting_view.do?method=view&id=<bean:write name="meeting" property="id" scope="page"/>'><bean:message key="button.view" /></a>
		<%if (!session.getAttribute(Constants.USERID_KEY).equals(Constants.NORMALUSER)) {%>
		<a href='meeting_edit.do?method=edit&id=<bean:write name="meeting" property="id" scope="page"/>'><bean:message key="button.edit" /></a>
