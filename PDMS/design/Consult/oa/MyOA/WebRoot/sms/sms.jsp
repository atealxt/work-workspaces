...
<TABLE border="0" width="809">
	...
	<TR>
		...
		<TD><bean:write name="sms" property="smstitle" scope="page"/></TD>
		<TD><bean:write name="sms" property="message" scope="page"/></TD>
		<TD><bean:write name="sms" property="sender" scope="page"/></TD>
		<TD><a href='sms_view.do?method=view&id=<bean:write name="sms" property="id" scope="page"/>'><bean:message key="button.view" /></a>
