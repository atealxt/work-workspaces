...
if (_st_ss == "") { 
	...
	else{ _st_url_sn = _st_g_u_sn(_st_ss) + 1; _ss_val = _st_g_ss_val(_st_ss); _st_ss = String(_st_url_sn)+"_"+_st_g_stm()+"_"+_ss_val; } _st_s_co("ystat_ss_"+String(_st_unit_id), _st_ss, 0); 
} 
...
_st_icon_link_host="tongji.alimama.com";

var open_url="http://"+_st_icon_link_host+"/note.html?unit_id="+_st_unit_id+"&url="+_st_url;
var open_win="javasc"+"ript:window.open ('"+open_url+"', 'newwindow', 'height=500, width=600, top=100, left=100, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no');";
document.writeln( "<a href='#' onClick=\""+open_win+"\">&#32473;&#25105;&#30041;&#35328;</a>" );
document.close();
