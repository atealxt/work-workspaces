...
public class TestLocalCache {
	...
	public static void testSet(final String key, final String value, final int start, final int end) {
        ...
        //	public void run() {
        		for(int i=start;i<end;i++) {
               		...
               		LocalCacheFactory.getInstance().set(i+key, i+value);
               		LocalCacheFactory.getInstance().get(i+key);
               		sleep(100);
               	}
        //	}
        //}.start();
	...
	public static void testGet(final String key, final int start, final int end) {
        ...
        //	public void run() {
               		...
               		//String value = 
        			LocalCacheFactory.getInstance().get(key);
	...
	public static void main(String[] args) {
		...
		TestLocalCache.testSet("fooa", "bar", 0, 10000); //写+读
