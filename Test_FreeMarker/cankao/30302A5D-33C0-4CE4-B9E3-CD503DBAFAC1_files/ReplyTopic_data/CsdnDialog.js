...
function CsdnDialog(title, left, top, width, height, closefree, fixup) {
    ...
    if (nonepng)
        this.td_top_left.style.backgroundImage = "url(" + imagePath + "corner.gif)";
    else this.td_top_left.style.backgroundImage = "url(" + imagePath + "corner.png)";
    this.td_top_left.style.backgroundPosition = "0px -100px";
    this.td_top_left.style.backgroundRepeat = "no-repeat";
    this.td_top_left.style.width = "35px";
    ...
    if (nonepng)
        this.td_top_center.style.backgroundImage = "url(" + imagePath + "vertical.gif)";
    else this.td_top_center.style.backgroundImage = "url(" + imagePath + "vertical.png)";
    this.td_top_center.style.width = (width - 35 - 35) + "px";
    ...
    if (nonepng)
        this.td_top_right.style.backgroundImage = "url(" + imagePath + "corner.gif)";
    else this.td_top_right.style.backgroundImage = "url(" + imagePath + "corner.png)";
    this.td_top_right.style.backgroundRepeat = "no-repeat";
    this.td_top_right.style.backgroundPosition = "-65px -100px";
    this.td_top_right.style.width = "35px";

    this.td_middle_left = this.tr_middle.insertCell(-1);
    if (nonepng)
        this.td_middle_left.style.backgroundImage = "url(" + imagePath + "horizontal.gif)";
    else this.td_middle_left.style.backgroundImage = "url(" + imagePath + "horizontal.png)";
    ...
    if (nonepng)
        this.td_middle_right.style.backgroundImage = "url(" + imagePath + "horizontal.gif)";
    else this.td_middle_right.style.backgroundImage = "url(" + imagePath + "horizontal.png)";
    this.td_middle_right.style.backgroundPosition = "-165px 0px";
    this.td_middle_right.style.backgroundRepeat = "repeat-y";

    this.td_bottom_left = this.tr_bottom.insertCell(-1);
    if (nonepng)
        this.td_bottom_left.style.backgroundImage = "url(" + imagePath + "corner.gif)";
    else this.td_bottom_left.style.backgroundImage = "url(" + imagePath + "corner.png)";
    ...
    if (nonepng)
        this.td_bottom_center.style.backgroundImage = "url(" + imagePath + "vertical.gif)";
    else this.td_bottom_center.style.backgroundImage = "url(" + imagePath + "vertical.png)";
    ...
    if (nonepng)
        this.td_bottom_right.style.backgroundImage = "url(" + imagePath + "corner.gif)";
    else this.td_bottom_right.style.backgroundImage = "url(" + imagePath + "corner.png)";
    this.td_bottom_right.style.backgroundRepeat = "no-repeat";
    this.td_bottom_right.style.backgroundPosition = "-65px -175px";
...
CsdnDialog.prototype.resize = function(left, top, width, height) {
    ...
    this.td_top_center.style.width = (width - 35 - 35) + "px";
    this.div_title.style.width = (width - 35 - 35 - 50) + "px";
    this.td_middle_center.style.height = (height - 40 - 25) + "px";
    this.div_html.style.width = (width - 35 - 35) + "px";
...
function showWindow(opts) {
    if (!currentDialog) {
        ...
        currentDialog.div_black.style.zIndex = "1";
        ...
        currentDialog.div_black.style.display = "";
    ...
    if (typeof opts.url == "string") {
        ...
        currentDialog.iframe.width = "100%";
        currentDialog.iframe.height = "100%";
