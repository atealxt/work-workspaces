...
public abstract class Engine {
    ...
    /** Release number. */
    public static final String RELEASE_NUMBER = ".7";
    ...
    public static Engine getInstance() {
        return new com.noelios.restlet.Engine();
...
//        return result;
     ...
     */
    public static void setInstance(final Engine engine) {
        instance = engine;
    }
     ...
     */
    public static void setUserClassLoader(final ClassLoader newClassLoader) {
