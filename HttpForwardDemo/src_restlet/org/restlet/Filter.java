...
public abstract class Filter extends Restlet {
     ...
     *            The context.
     */
    public Filter(final Context context) {
        this(context, null);
    }
     ...
     *            The next Restlet.
     */
    public Filter(final Context context, final Restlet next) {
        super(context);
        this.next = next;
    }
...
//        return CONTINUE;
        ...
        try {
            ...
            final String urlPre = "/cic-manage/rest/dispathController/IM";
     ...
     */
    public void setNext(final Class<? extends Resource> targetClass) {
