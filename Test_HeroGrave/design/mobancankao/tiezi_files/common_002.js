...
function convertdate(strdate)
{
	...
	if (d.getYear() == now.getYear() && d.getMonth() == now.getMonth())
	{
		...
		{
			case 0:
				result = "今天 " + gettBytesNum(d.getHours()) + " : " + gettBytesNum(d.getMinutes());
				break;
			case 1:
				result = "昨天 " + gettBytesNum(d.getHours()) + " : " + gettBytesNum(d.getMinutes());
				break;
			case 2:
				result = "前天 " + gettBytesNum(d.getHours()) + " : " + gettBytesNum(d.getMinutes());
				break;
			default:
