...
function outputRatelog(doc, pid, aspxrewrite)
{
	...
	var html = "<table border='0' cellpadding='0' cellspacing='0' style='width:620px;'>";
	...
	for (var i = 0; i < ratelist.length; i++ )
	{
        ...
        if(aspxrewrite == 1)
        {
		    html += "<tr><td width='15%'><a target='_blank' href='userinfo-" + uid + ".aspx'>" + username + "</a></td><td width='30%'>&nbsp;&nbsp;" + postdatetime + "</td><td width='15%'>&nbsp;&nbsp;" + extcreditsname + "&nbsp;&nbsp;<b>" + score + "</b>&nbsp;" + extcreditsunit + "</td><td>&nbsp;&nbsp;" + reason + "</td></tr>";
		}
		else
		{
...
{
	identify.style.left = ((document.body.clientWidth - $('container').clientWidth)/2 + $('container').clientWidth - 200) + 'px';
